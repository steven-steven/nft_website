    ...
    return (
        <div className="pt-8 font-forward font-normal">
            <div className="flex flex-col place-items-center">
                ...
                <div className="font-mono text-center text-xs md:text-xl pt-8 md:pt-20 w-2/3 lg:w-1/3">
                    Duck Duck Goose is a collection of programmatically generated 40x40 pixel art assets.
                ...
                <div className="font-mono text-center text-xs md:text-xl pt-8 md:pt-10 w-2/3 lg:w-1/3">
