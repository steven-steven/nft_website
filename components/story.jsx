        ...
        <div className="font-forward font-normal">
            <div className="flex flex-col place-items-center">
                ...
                <p className="font-roboto text-left text-xs md:text-xl pt-4 md:pt-10 w-5/6 lg:w-1/3">
                    But you gradually noticed that you are a little different from others<br />
                    Your neck was a little too long<br />
                    Your pace was a little too slow<br />
                    Your voice was too loud<br />
                    Your words were too straightforward<br />
                    You found out that you seem to be a Goose<br />
                    They started to reject you<br />
                </p>
