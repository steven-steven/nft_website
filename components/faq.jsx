        ...
        <div className="pt-8 md:pt-28 font-forward font-normal">
            <div className="flex flex-col place-items-center">
                ...
                <p className="font-roboto text-left text-xs md:text-xl pt-4 md:pt-10 w-5/6 lg:w-1/3">
                    ...
                    Twitter <a className="font-robotoBold text-danger underline" href={props.twitter} target="_blank">@DDGNFT</a> and our <a className="font-robotoBold text-danger underline" href={props.discord} target="_blank">Discord</a> are the only official social contacts.<br /> 
